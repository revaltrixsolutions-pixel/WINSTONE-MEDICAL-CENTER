...
app.listen(PORT, () => {
  ...
  console.log(
    ` Shop:           http://localhost:${PORT}/api/shop`
  );
  console.log(
    ` Shop Products:  http://localhost:${PORT}/api/shop/products`
  );
  console.log(
    ` Shop Orders:    http://localhost:${PORT}/api/shop/orders`
  );
  console.log(
    ` Shop Admin:     http://localhost:${PORT}/api/shop/admin`
  );
  console.log(
