          ...
          <div className="max-w-5xl mx-auto space-y-8 animate-fadeIn">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-300">
                Select an administration module below to manage patient appointments, schedules, doctors, shop inventory, gallery, and medical offerings.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Link
                to="/admin/shop"
                className="group rounded-3xl border border-white/10 bg-gradient-to-b from-white/[0.08] to-white/[0.02] p-8 shadow-2xl transition-all hover:border-blue-400/50 hover:bg-white/[0.12] flex flex-col justify-between"
              >
                <div>
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/30 mb-6 group-hover:scale-110 transition-transform">
                    <ShoppingBag size={26} />
                  </div>
                  <h3 className="text-xl font-bold text-white group-hover:text-blue-300 transition-colors">Shop & Orders</h3>
                  <p className="mt-2 text-sm text-slate-300 leading-relaxed">
                    Manage products, inventory levels, pricing, and track incoming customer orders and payment statuses.
                  </p>
                </div>
                <div className="mt-8 flex items-center gap-2 text-xs font-bold text-blue-400">
                  <span>Open Shop Module</span>
                  <ArrowRight size={15} className="transition-transform group-hover:translate-x-1.5" />
                </div>
              </Link>
